...
export const metadata: Metadata = {
  title: 'Inscription confirmée — Le Commerce Agentique',
...
export default async function NewsletterConfirmePage({ searchParams }: Props) {
  ...
  const content =
    status === 'expired'
      ? {
          ...
          body: "Ce lien de confirmation a expiré (validité 7 jours). Réinscrivez-vous depuis la page d'accueil pour recevoir un nouveau lien.",
        }
      : status === 'invalid'
      ? {
          title: 'Lien invalide',
          eyebrow: 'Confirmation',
          body: "Ce lien n'est pas reconnu. Réinscrivez-vous depuis la page d'accueil ou contactez-nous si le problème persiste.",
        }
      : {
          title: 'Inscription confirmée.',
          eyebrow: 'Bienvenue',
          body: "Votre adresse est confirmée. Vous recevrez Le Brief A-commerce dans votre boîte mail dès la prochaine édition. Sans spam, et désinscription en un clic.",
        }
